...
const SocialContact = () => {
    ...
    const socialLinks = [
        ...
        },
        {
            id: 'twitter',
            label: 'Twitter',
            url: 'https://twitter.com/jhosep_ac',
            icon: (
                <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
        ...
        },
        {
            id: 'instagram',
            label: 'Instagram',
            url: 'https://instagram.com/jhosep.ac',
            icon: (
                <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
        ...
        <div className="social-contact">
            ...
            <div className="social-contact-links">
                {socialLinks.map((social, index) => (
                    ...
                    >
                        <span className="social-contact-icon">{social.icon}</span>
                        <span className="social-contact-label">{social.label}</span>
                    </a>
                ))}
            </div>
        </div>
